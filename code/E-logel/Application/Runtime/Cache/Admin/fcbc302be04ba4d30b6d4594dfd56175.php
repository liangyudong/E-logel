            ...
            <div class="userbox">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="/admin/login/index"><i class="fa fa-power-off"></i>退出登录</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="container-fluid content">
	...
	<div class="page-header">
		<div class="pull-left">
			<ol class="breadcrumb visible-sm visible-md visible-lg">
				...
				<li class="active"><a href="#">精品贴推荐</a></li>
			</ol>
		</div>
					...
					<div class="panel">
						...
						<div class="panel-heading bk-bg-primary">
							<h6><i class="fa fa-table red"></i><span class="break"></span>帖子精华推荐</h6>
						</div>
 ...
 switch ($p["boss_deal"]){ case 0: echo "否"; break; case 1: echo "已推送"; break; default: echo 'error'; break; } ?></span>
										</td>
										<td>
